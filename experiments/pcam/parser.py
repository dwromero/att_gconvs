...
def _get_parser():
    # Running settings
    parser = argparse.ArgumentParser(description='pcam experiments.')
    # Parse
    parser.add_argument('--model', type=str, default='densenet', metavar='M', help='type of model to use {z2cnn, p4cnn, attp4cnn}')
